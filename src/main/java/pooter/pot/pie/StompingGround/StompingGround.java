package pooter.pot.pie.StompingGround;
...
@Mod("stompingground")
public class StompingGround
{
    // Directly reference a log4j logger.
    public static final Logger LOGGER = LogManager.getLogger();
    private int UniquePacketID = 0;
    public static final String MODID = "stompingground";
    ...
    private void setup(final FMLCommonSetupEvent event)
    {
        ...
        StompingGroundPacketHandler.register();
    ...
    private void doClientStuff(final FMLClientSetupEvent event) {
        ...
        new StompingGroundItemGroup("stomping_ground", ()->new ItemStack(Items.CAMPFIRE));
